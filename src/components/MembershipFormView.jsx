      ...
      <div className="max-w-3xl mx-auto px-5">
        ...
        <div className="bg-gradient-to-r from-[#0a361e] to-[#0f5132] p-8 text-white text-center border-b-4 border-[#a16207] shadow-lg mb-8" style={{ borderRadius: '2px' }}>
          ...
          <h1 className="text-2xl sm:text-3xl font-display font-black tracking-wide">
            {language === 'en' ? 'Telangana Jagruthi Membership Portal' : 'తెలంగాణ జాగృతి సభ్యత్వ నమోదు'}
          </h1>
              ...
              >
                <div className="pb-4 border-b border-gray-100">
                  <h2 className="text-lg font-black text-[#0a361e] font-display flex items-center gap-2">
                    ...
                    {language === 'en' ? 'Step 3: Membership Pledge' : 'దశ 3: తెలంగాణ జాగృతి ప్రమాణ స్వీకారం'}
                  </h2>
                </div>
                ...
                <div className="border border-[#a16207]/30 bg-[#fffbeb] p-6 text-sm leading-relaxed text-[#3a2503] italic font-serif">
                  ...
                  {language === 'en' ? (
                    `"I hereby declare that I reside in Telangana, subscribe fully to the core values of Telangana Jagruthi, and will actively dedicate my time to the preservation of our cultural heritage, the promotion of youth education and development, and social empowerment programs. I vow to work selflessly towards the creation of a Samajika Telangana (Social Telangana) as envisioned by the founding leadership."`
                  ) : (
                    `"తెలంగాణ జాగృతి యొక్క మూల సిద్ధాంతాలకు కట్టుబడి ఉంటూ, మన సంస్కృతి సంప్రదాయాల పరిరక్షణకు, యువత విద్యా ఉపాధి అవకాశాల సాధనకు, సామాజిక సాధికారతకు నిస్వార్థంగా కృషి చేస్తానని ప్రమాణం చేస్తున్నాను. కల్వకుంట్ల కవిత గారి నాయకత్వంలో సామాజిక తెలంగాణ నిర్మాణానికి నా వంతు బాధ్యతగా పనిచేస్తానని సగర్వంగా ప్రకటిస్తున్నాను."`
                  )}
                </div>
                ...
                <div className="flex items-start gap-3 mt-4">
                  ...
                  <label htmlFor="pledge" className="text-xs text-gray-600 cursor-pointer select-none">
                    {language === 'en' 
                      ? 'I agree and solemnly accept the membership pledge of Telangana Jagruthi.' 
                      : 'నేను అంగీకరిస్తున్నాను మరియు తెలంగాణ జాగృతి సభ్యత్వ ప్రమాణ స్వీకారాన్ని మనస్ఫూర్తిగా స్వీకరిస్తున్నాను.'} *
                  </label>
                </div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-2 max-w-md mx-auto">
                    {language === 'en' 
                      ? 'Congratulations! You are now an official registered member of Telangana Jagruthi. Your digital membership card is generated below.'
                      : 'అభినందనలు! మీరు ఇప్పుడు తెలంగాణ జాగృతిలో అధికారిక సభ్యులుగా చేరారు. మీ సభ్యత్వ డిజిటల్ కార్డు క్రింద సిద్ధంగా ఉంది.'}
                  </p>
                </div>
                ...
                <div className="max-w-md mx-auto bg-gradient-to-br from-[#0a361e] via-[#0f5132] to-[#14532d] p-6 text-white border-2 border-[#a16207]/40 shadow-2xl relative select-none print:shadow-none print:border-black rounded-lg text-left" id="membership-card">
                  ...
                  <div className="absolute inset-0 opacity-[0.04] pointer-events-none"
                    style={{
                      backgroundImage: "url('/tj-logo.png')",
                  ...
                  <div className="flex justify-between items-start pb-4 border-b border-white/10 relative z-10">
                    <div className="flex items-center gap-2.5">
                      <img src="/tj-logo.png" alt="TJ Logo" className="h-10 w-10 object-contain bg-white/10 p-0.5 rounded-full" />
                      <div>
